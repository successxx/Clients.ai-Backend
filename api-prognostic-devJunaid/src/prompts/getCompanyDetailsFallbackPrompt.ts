export const getCompanyDetailsFallbackPrompt = (websiteUrl: string) => {
  ...
  Here's the company website you need to use to extract all the information: ${websiteUrl}
